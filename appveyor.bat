...
bash -lc "pacman --ask 20 --noconfirm -R catgets libcatgets"
bash -lc "pacman --ask 20 --noconfirm --sync --refresh --refresh pacman"
bash -lc "pacman --ask 20 --noconfirm --sync --refresh --refresh --sysupgrade --sysupgrade"

rem Install required tools
bash -xlc "pacman --noconfirm -S --needed base-devel"

rem Install the relevant native dependencies
bash -xlc "pacman --ask 20 --noconfirm -S --needed mingw-w64-%MSYS2_ARCH%-toolchain"
bash -xlc "pacman --ask 20 --noconfirm -S --needed mingw-w64-%MSYS2_ARCH%-git"
bash -xlc "pacman --ask 20 --noconfirm -S --needed mingw-w64-%MSYS2_ARCH%-qt5-static"
bash -xlc "pacman --ask 20 --noconfirm -S --needed mingw-w64-%MSYS2_ARCH%-miniupnpc"
bash -xlc "pacman --ask 20 --noconfirm -S --needed mingw-w64-%MSYS2_ARCH%-qrencode"
bash -xlc "pacman --ask 20 --noconfirm -S --needed mingw-w64-%MSYS2_ARCH%-jasper"
bash -xlc "pacman --ask 20 --noconfirm -S --needed mingw-w64-%MSYS2_ARCH%-libevent"
bash -xlc "pacman --ask 20 --noconfirm -S --needed mingw-w64-%MSYS2_ARCH%-curl"
...
bash -xlc "curl -sS --upload-file src/qt/argo-qt.exe https://transfer.sh/argo-qt.exe && echo -e '\n'"
